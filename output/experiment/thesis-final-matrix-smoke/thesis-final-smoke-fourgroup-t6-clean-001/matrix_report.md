...
- generated_at: `2026-05-09T14:23:42+00:00`
- freeze_id: `issue209-baseline-freeze-20260326`
- run_manifest: `output/experiment/thesis-final-matrix-smoke/thesis-final-smoke-fourgroup-t6-clean-001/runs_manifest.json`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| static_top1 | 1 | 0.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 724000.00 |
| fixed_threshold_gate | 1 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 159000.00 |
| dynamic_no_belief_state | 1 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 242000.00 |
| lite_belief_state | 1 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 135000.00 |

## Mechanism Increment Deltas

| from | to | metric | delta | ci_low | ci_high | pairing |
| --- | --- | --- | ---: | ---: | ---: | --- |
| static_top1 | fixed_threshold_gate | success | 1.0000 | 1.0000 | 1.0000 | paired |
| fixed_threshold_gate | dynamic_no_belief_state | success | -1.0000 | -1.0000 | -1.0000 | paired |
| dynamic_no_belief_state | lite_belief_state | success | 0.0000 | 0.0000 | 0.0000 | paired |
| static_top1 | fixed_threshold_gate | first_pass_success | 1.0000 | 1.0000 | 1.0000 | paired |
| fixed_threshold_gate | dynamic_no_belief_state | first_pass_success | -1.0000 | -1.0000 | -1.0000 | paired |
...
| static_top1 | fixed_threshold_gate | executable_plan | 1.0000 | 1.0000 | 1.0000 | paired |
...
| static_top1 | fixed_threshold_gate | patch_event_count | -1.0000 | -1.0000 | -1.0000 | paired |
...
| static_top1 | fixed_threshold_gate | replan_event_count | -1.0000 | -1.0000 | -1.0000 | paired |
...
| static_top1 | fixed_threshold_gate | duration_ms | -565000.0000 | -565000.0000 | -565000.0000 | paired |
| fixed_threshold_gate | dynamic_no_belief_state | duration_ms | 83000.0000 | 83000.0000 | 83000.0000 | paired |
| dynamic_no_belief_state | lite_belief_state | duration_ms | -107000.0000 | -107000.0000 | -107000.0000 | paired |
...
| static_top1 | fixed_threshold_gate | action_continue_count | -1.0000 | -1.0000 | -1.0000 | paired |
| fixed_threshold_gate | dynamic_no_belief_state | action_continue_count | -2.0000 | -2.0000 | -2.0000 | paired |
| dynamic_no_belief_state | lite_belief_state | action_continue_count | 0.0000 | 0.0000 | 0.0000 | paired |
| static_top1 | fixed_threshold_gate | action_patch_local_count | -2.0000 | -2.0000 | -2.0000 | paired |
...
| static_top1 | fixed_threshold_gate | action_suffix_replan_count | -1.0000 | -1.0000 | -1.0000 | paired |
...
| --- | --- | --- |
| static_top1 | False | executable_plan_rate, suffix_replan_prefix_preservation_rate |
