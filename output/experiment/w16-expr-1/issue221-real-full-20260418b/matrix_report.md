...
- generated_at: `2026-04-18T04:36:57+00:00`
- freeze_id: `issue209-baseline-freeze-20260326`
- run_manifest: `output/experiment/w16-expr-1/issue221-real-full-20260418b/runs_manifest.json`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| static_top1 | 7 | 1.0000 | 0.5714 | 1.0000 | 1.0000 | 0.2857 | 0.4286 | 0.0000 | 252285.71 |
| fixed_threshold_gate | 7 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 39142.86 |
| dynamic_no_belief_state | 7 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 21857.14 |
| lite_belief_state | 7 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 | 3428.57 |
...
| static_top1 | fixed_threshold_gate | first_pass_success | -0.5714 | -0.8571 | -0.1429 | paired |
...
| static_top1 | fixed_threshold_gate | patch_event_count | -0.4286 | -0.8571 | -0.1429 | paired |
...
| static_top1 | fixed_threshold_gate | duration_ms | -213142.8571 | -285714.2857 | -133428.5714 | paired |
| fixed_threshold_gate | dynamic_no_belief_state | duration_ms | -17285.7143 | -32285.7143 | -4142.8571 | paired |
| dynamic_no_belief_state | lite_belief_state | duration_ms | -18428.5714 | -30000.0000 | -4000.0000 | paired |
| static_top1 | fixed_threshold_gate | high_cost_call_count | -0.2857 | -0.5714 | 0.0000 | paired |
...
| static_top1 | fixed_threshold_gate | action_continue_count | -4.0000 | -4.5714 | -3.4286 | paired |
| fixed_threshold_gate | dynamic_no_belief_state | action_continue_count | -0.1429 | -0.4286 | 0.0000 | paired |
| dynamic_no_belief_state | lite_belief_state | action_continue_count | 0.0000 | 0.0000 | 0.0000 | paired |
| static_top1 | fixed_threshold_gate | action_patch_local_count | -0.4286 | -0.8571 | -0.1429 | paired |
...
| --- | --- | --- |
| static_top1 | False | suffix_replan_prefix_preservation_rate |
