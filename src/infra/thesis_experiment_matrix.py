...
DEFAULT_ISSUE221_CONFIG_PATH = Path(
    "configs/experiments/adaptive_strategy_experiment_matrix.json"
)
        ...
        for task in matrix["tasks"]:
            ...
            for replicate in range(1, repeat_count + 1):
                ...
                merged_metadata = deep_merge(
                    ...
                    {
                        "issue_id": issue_id,
                        "experiment": "thesis_experiment_matrix",
                        "group_id": group_id,
...
def _build_issue221_markdown_report(
    *,
    ...
    issue221_header = "# Thesis Four-Group Experiment Matrix Report"
