...
def analyze_issue222_results(
    *,
    ...
    source_eval_dir = output_dir / "source_matrix_evaluation"
    ...
    (output_dir / "integration_analysis_report.md").write_text(
