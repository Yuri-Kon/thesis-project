...
from src.models.db import to_external_status
...
def configure_test_hooks(
    *,
    event_appender: Callable[[str, dict[str, Any]], None],
    audit_persister: Callable[..., Path],
) -> None:
    global append_event
    global persist_structure_refinement_audit
    append_event = event_appender
    persist_structure_refinement_audit = audit_persister


def project_structures_from_s1(
    self: ProteinExecutorLike,
