...
def _load_module():
    module_path = Path(__file__).resolve().parents[2] / "scripts" / "generate_interim_release_pack.py"
    spec = importlib.util.spec_from_file_location("interim_release_pack", module_path)
