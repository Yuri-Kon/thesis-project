...
| TC-S10 | 异常输入与安全 warn/block 验证 | EXP-S6 | SV-04、SV-05、SV-06、SV-11、SV-13、SV-21、SV-24 | 单元 / API | 通过 | `tests/unit/test_safety_agent.py`、`tests/api/test_api_endpoints.py` pytest 通过；错误响应 JSON、SafetyResult、状态未变更日志 |
...
| Web / CLI 可用性验证 | TC-S07、TC-S08 | 前端页面、CLI 命令、同一任务证据展示 | 通过 | web smoke、CLI pytest、截图、CLI 输出 |
...
| 异常与安全边界验证 | TC-S10、TC-S13 | 缺字段、错误决策、安全 warn/block、止损 | 部分通过 | TC-S10 通过；TC-S13 terminal stop / 止损链路待补 |
