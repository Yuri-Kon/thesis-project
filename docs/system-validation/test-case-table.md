...
|---|---|---|---|---|---|---|
| TC-S01 | 环境与能力就绪验证 | EXP-S1 | SV-01、SV-27 | API / 环境 | 通过 | health JSON、readiness JSON、启动日志 |
...
| TC-S09 | 正常端到端任务流程验证 | EXP-S5 | SV-16、SV-25、SV-26 | 集成 / API | 通过 | t8 四组 smoke run + t9 四组 clean run（16/16 DONE）；API report focused test 通过 |
...
| TC-S11 | 工具链执行与 I/O 边界验证 | EXP-S5、EXP-S6 | SV-16、SV-17 | 集成 / 单元 | 通过 | t8/t9 工具链成功日志；候选 schema/I-O 边界 focused test 通过 |
