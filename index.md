...
最后更新：2026-05-11（第六、七章草稿完成，下一阶段转入结构拆分与实现章写作）
...
| 🥈 2 | **第 5 章：系统实现** | 素材充足（`implementation/` 6 文件），需压缩为可提交正文 |
| 🥉 3 | **第 6+7 章：测试与实验** | Markdown 草稿均已完成，下一步是校准图表编号并转 LaTeX |
...
2. **并行**：压缩 `implementation/` 素材，形成第 5 章系统实现草稿。
3. **整理**：为第 6、7 章补齐图表编号、表格题注和证据引用格式，然后转 LaTeX。
4. **结构同步**：将 `paper/tex/stages/final.tex` 从当前 7 章结构同步为 8 章结构，新增第 3、4、5、6、7、8 章文件入口。
