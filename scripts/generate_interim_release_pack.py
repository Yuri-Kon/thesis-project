...
DEFAULT_RUNTIME_FALLBACK_CONFIG = Path("configs/runtime/dual_route_fallback.json")
DEFAULT_RUNTIME_RUNBOOK = Path("scripts/dual-route-fallback-runbook.md")
...
def render_three_week_report(
    *,
    ...
    lines = [
        "# W12 三周成果总报告（Interim Release Pack）",
        "",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate the interim release/report pack."
    )
