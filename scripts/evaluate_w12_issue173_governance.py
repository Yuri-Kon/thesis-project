...
def render_report_markdown(
    *,
    ...
    lines = [
        ...
        "",
        "## Repro Command",
        f"- `python scripts/evaluate_w12_issue173_governance.py --run-log-index {run_log_index} --output-dir {output_dir}`",
        "",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate issue #173 governance metrics.")
