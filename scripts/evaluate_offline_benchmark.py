...
def render_release_markdown(
    *,
    ...
    lines = [
        ...
        f"- Command: `python scripts/evaluate_offline_benchmark.py --summary-csv {summary_csv} --slice-csv {slice_csv} --self-group {self_group} --baseline-group {baseline_group}`",
        "",
        "## Metric Definitions",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Generate offline benchmark results (candidate vs external baseline)."
    )
