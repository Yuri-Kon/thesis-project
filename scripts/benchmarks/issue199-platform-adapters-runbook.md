# Issue #199：Inspect AI + MLflow + promptfoo 平台接入与复现 Runbook
...
- `issue199_platform_adapter_manifest.json`
- `issue199_platform_adapter_report.md`
- `inspect_ai/inspect_react_samples.jsonl`
- `inspect_ai/inspect_issue199_react_smoke.py`
- `inspect_ai/inspect_eval_manifest.json`
- `mlflow/mlflow_react_samples.jsonl`
- `mlflow/mlflow_issue199_react_eval.py`
...
ISSUE199_INSPECT_DATASET=/abs/path/to/output/experiment/w15-expr-0/<freeze_id>/inspect_ai/inspect_react_samples.jsonl \
uv tool run --from inspect-ai --with openai inspect eval \
  output/experiment/w15-expr-0/<freeze_id>/inspect_ai/inspect_issue199_react_smoke.py \
...
ISSUE199_MLFLOW_DATASET=/abs/path/to/output/experiment/w15-expr-0/<freeze_id>/mlflow/mlflow_react_samples.jsonl \
uv run --with mlflow python \
  output/experiment/w15-expr-0/<freeze_id>/mlflow/mlflow_issue199_react_eval.py
```
