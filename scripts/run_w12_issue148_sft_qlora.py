...
DEFAULT_CONFIG_PATH = Path("configs/training/w12_issue148_sft_qlora_p0_only.json")
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Run Week12 issue #148 baseline SFT/QLoRA training and export model package artifacts."
        )
    )
